...
type FUOTADeployment struct {
	...
	// Encoding algorithm
	FragAlgo uint32 `protobuf:"varint,8,opt,name=frag_algo,json=fragAlgo,proto3" json:"frag_algo,omitempty"`
	// Multicast time-out.
	...
	MulticastTimeout uint32 `protobuf:"varint,9,opt,name=multicast_timeout,json=multicastTimeout,proto3" json:"multicast_timeout,omitempty"`
	// Unicast time-out.
...
var fileDescriptor_0ae912e3feed0382 = []byte{
	...
	,
}
